...
//  CTXMAMCore
//
//  Created by Daniel Romano on 2/21/19.
 ...
 */
void CTXMAMLOG_Message(NSString * source, int level, int logType, const char * file, const char * func, int line, NSString * fmt, ...);
...
/*!
 ...
 @param fmt A standard format string which contains the customized message to be logged out to the logger.
 */
+(void) CTXMAMLog_CriticalErrorFrom:   (NSString *)source andFile:(nullable NSString *)fileName andFunction:(nullable NSString *)functionName atLine:(int) lineNumber withFormat:(NSString *)fmt, ...;
/*!
 ...
 @param fmt A standard format string which contains the customized message to be logged out to the logger.
 */
+(void) CTXMAMLog_ErrorFrom:           (NSString *)source andFile:(nullable NSString *)fileName andFunction:(nullable NSString *)functionName atLine:(int) lineNumber withFormat:(NSString *)fmt, ...;
/*!
 ...
 @param fmt A standard format string which contains the customized message to be logged out to the logger.
 */
+(void) CTXMAMLog_WarningFrom:         (NSString *)source andFile:(nullable NSString *)fileName andFunction:(nullable NSString *)functionName atLine:(int) lineNumber withFormat:(NSString *)fmt, ...;
/*!
 ...
 @param fmt A standard format string which contains the customized message to be logged out to the logger.
 */
+(void) CTXMAMLog_InfoFrom:            (NSString *)source andFile:(nullable NSString *)fileName andFunction:(nullable NSString *)functionName atLine:(int) lineNumber withFormat:(NSString *)fmt, ...;
/*!
 ...
 @param fmt A standard format string which contains the customized message to be logged out to the logger.
 */
+(void) CTXMAMLog_DetailFrom:          (NSString *)source andFile:(nullable NSString *)fileName andFunction:(nullable NSString *)functionName atLine:(int) lineNumber withFormat:(NSString *)fmt, ...;
